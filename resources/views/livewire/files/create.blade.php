    ...
    <form wire:submit="save">
        <div class="grid grid-cols-4 gap-2">
            ...
            <div class="max-w-xl col-span-2 py-2">
                ...
                <select name="types" id="types" wire:model="type_id" class="border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600">
